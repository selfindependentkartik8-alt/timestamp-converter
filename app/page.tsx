    ...
    <div className="mb-10">
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <a
          ...
          className="group rounded-2xl border border-white/10 bg-white/[0.03] p-5 transition-all duration-300 hover:-translate-y-1 hover:border-cyan-300/30 hover:bg-cyan-300/[0.04]"
        >

          <div className="mb-4 flex h-11 w-11 items-center justify-center rounded-xl border border-cyan-300/20 bg-cyan-300/10 text-lg">
            📐
          </div>
          ...
          <p className="mt-2 text-xs leading-5 text-zinc-500">
            Convert measurements and units quickly and accurately.
          </p>
